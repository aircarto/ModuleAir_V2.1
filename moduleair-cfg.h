...
enum ConfigShapeId {
  ...
  Config_logo_moduleair,
  Config_logo_aircarto,
  Config_logo_atmo,
  Config_logo_region,
  Config_logo_custom1,
  Config_logo_custom2,
...
static constexpr char CFG_KEY_WWW_BASICAUTH_ENABLED[] PROGMEM =
    "www_basicauth_enabled";
static constexpr char CFG_KEY_NPM_READ[] PROGMEM = "npm_read";
static constexpr char CFG_KEY_BMX280_READ[] PROGMEM = "bmx280_read";
static constexpr char CFG_KEY_HEIGHT_ABOVE_SEALEVEL[] PROGMEM =
...
static constexpr char CFG_KEY_DISPLAY_DEVICE_INFO[] PROGMEM =
    "display_device_info";
static constexpr char CFG_KEY_DEBUG[] PROGMEM = "debug";
static constexpr char CFG_KEY_SENDING_INTERVALL_MS[] PROGMEM =
    "sending_intervall_ms";
static constexpr char CFG_KEY_TIME_FOR_WIFI_CONFIG[] PROGMEM =
    "time_for_wifi_config";
...
static constexpr char CFG_KEY_LOGO_MODULEAIR[] PROGMEM = "logo_moduleair";
static constexpr char CFG_KEY_LOGO_AIRCARTO[] PROGMEM = "logo_aircarto";
static constexpr char CFG_KEY_LOGO_ATMO[] PROGMEM = "logo_atmo";
static constexpr char CFG_KEY_LOGO_REGION[] PROGMEM = "logo_region";
static constexpr char CFG_KEY_LOGO_CUSTOM1[] PROGMEM = "logo_custom1";
static constexpr char CFG_KEY_LOGO_CUSTOM2[] PROGMEM = "logo_custom2";
static constexpr ConfigShapeEntry configShape[] PROGMEM = {
    ...
    {Config_Type_String, sizeof(cfg::current_lang) - 1, CFG_KEY_CURRENT_LANG,
     cfg::current_lang},
    {Config_Type_String, sizeof(cfg::wlanssid) - 1, CFG_KEY_WLANSSID,
     cfg::wlanssid},
    {Config_Type_Password, sizeof(cfg::wlanpwd) - 1, CFG_KEY_WLANPWD,
     cfg::wlanpwd},
    {Config_Type_String, sizeof(cfg::www_username) - 1, CFG_KEY_WWW_USERNAME,
     cfg::www_username},
    {Config_Type_Password, sizeof(cfg::www_password) - 1, CFG_KEY_WWW_PASSWORD,
     cfg::www_password},
    {Config_Type_String, sizeof(cfg::fs_ssid) - 1, CFG_KEY_FS_SSID,
     cfg::fs_ssid},
    {Config_Type_Password, sizeof(cfg::fs_pwd) - 1, CFG_KEY_FS_PWD,
     cfg::fs_pwd},
    {Config_Type_Bool, 0, CFG_KEY_WWW_BASICAUTH_ENABLED,
     &cfg::www_basicauth_enabled},
    {Config_Type_Bool, 0, CFG_KEY_NPM_READ, &cfg::npm_read},
    {Config_Type_Bool, 0, CFG_KEY_BMX280_READ, &cfg::bmx280_read},
    {Config_Type_String, sizeof(cfg::height_above_sealevel) - 1,
     CFG_KEY_HEIGHT_ABOVE_SEALEVEL, cfg::height_above_sealevel},
    ...
    {Config_Type_String, sizeof(cfg::latitude) - 1, CFG_KEY_LATITUDE,
     cfg::latitude},
    {Config_Type_String, sizeof(cfg::longitude) - 1, CFG_KEY_LONGITUDE,
     cfg::longitude},
    ...
    {Config_Type_Bool, 0, CFG_KEY_DISPLAY_DEVICE_INFO,
     &cfg::display_device_info},
    {Config_Type_UInt, 0, CFG_KEY_DEBUG, &cfg::debug},
    {Config_Type_Time, 0, CFG_KEY_SENDING_INTERVALL_MS,
     &cfg::sending_intervall_ms},
    {Config_Type_Time, 0, CFG_KEY_TIME_FOR_WIFI_CONFIG,
     &cfg::time_for_wifi_config},
    {Config_Type_Bool, 0, CFG_KEY_SEND2CUSTOM, &cfg::send2custom},
    {Config_Type_String, sizeof(cfg::host_custom) - 1, CFG_KEY_HOST_CUSTOM,
     cfg::host_custom},
    {Config_Type_String, sizeof(cfg::url_custom) - 1, CFG_KEY_URL_CUSTOM,
     cfg::url_custom},
    {Config_Type_UInt, 0, CFG_KEY_PORT_CUSTOM, &cfg::port_custom},
    {Config_Type_String, sizeof(cfg::user_custom) - 1, CFG_KEY_USER_CUSTOM,
     cfg::user_custom},
    {Config_Type_Password, sizeof(cfg::pwd_custom) - 1, CFG_KEY_PWD_CUSTOM,
     cfg::pwd_custom},
    {Config_Type_Bool, 0, CFG_KEY_SSL_CUSTOM, &cfg::ssl_custom},
    {Config_Type_Bool, 0, CFG_KEY_SEND2CUSTOM2, &cfg::send2custom2},
    {Config_Type_String, sizeof(cfg::host_custom2) - 1, CFG_KEY_HOST_CUSTOM2,
     cfg::host_custom2},
    {Config_Type_String, sizeof(cfg::url_custom2) - 1, CFG_KEY_URL_CUSTOM2,
     cfg::url_custom2},
    {Config_Type_UInt, 0, CFG_KEY_PORT_CUSTOM2, &cfg::port_custom2},
    {Config_Type_String, sizeof(cfg::user_custom2) - 1, CFG_KEY_USER_CUSTOM2,
     cfg::user_custom2},
    {Config_Type_Password, sizeof(cfg::pwd_custom2) - 1, CFG_KEY_PWD_CUSTOM2,
     cfg::pwd_custom2},
    {Config_Type_Bool, 0, CFG_KEY_SSL_CUSTOM2, &cfg::ssl_custom2},
    {Config_Type_Bool, 0, CFG_KEY_NEBULEAIR_READ, &cfg::nebuleair_read},
    {Config_Type_String, sizeof(cfg::nebuleair_id) - 1, CFG_KEY_NEBULEAIR_ID,
     cfg::nebuleair_id},
    ...
    {Config_Type_UInt, 0, CFG_KEY_LOGO_MODULEAIR, &cfg::logo_moduleair},
    {Config_Type_UInt, 0, CFG_KEY_LOGO_AIRCARTO, &cfg::logo_aircarto},
    {Config_Type_UInt, 0, CFG_KEY_LOGO_ATMO, &cfg::logo_atmo},
    {Config_Type_UInt, 0, CFG_KEY_LOGO_REGION, &cfg::logo_region},
    {Config_Type_UInt, 0, CFG_KEY_LOGO_CUSTOM1, &cfg::logo_custom1},
    {Config_Type_UInt, 0, CFG_KEY_LOGO_CUSTOM2, &cfg::logo_custom2},
};
