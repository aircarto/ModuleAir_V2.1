...
// mDNS hostname (access device via "MDNS_HOSTNAME.local" on local network)
// This allows you to access the web interface using http://moduleair.local
// instead of having to know the IP address
#define MDNS_HOSTNAME "moduleair"
...
#define PORT_CUSTOM 443 // 80 for HTTP and 443 for HTTPS
#define USER_CUSTOM ""
#define PWD_CUSTOM ""
#define SSL_CUSTOM 1 // -> 1 to activate HTTPS

// WIFI API 2 (AtmoSud MicroSpot)
static const char HOST_CUSTOM2[] PROGMEM = "api-prod.uspot.probesys.net";
static const char URL_CUSTOM2[] PROGMEM = "/moduleair?token=2AFF6dQk68daFZ";
#define PORT_CUSTOM2 443 // 81 ou 443 pour le HTTPS
#define USER_CUSTOM2 ""
#define PWD_CUSTOM2 ""
#define SSL_CUSTOM2 1 // 0 ou 1 pour activer le HTTPS
...
static const char URL_API_SENSORCOMMUNITY[] PROGMEM =
