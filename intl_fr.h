...
const char INTL_AB_HIER_NUR_ANDERN[] PROGMEM =
    "Paramètres avancés (seulement si vous savez ce que vous faites)";
...
const char INTL_TEMP_OFFSET[] PROGMEM =
    "Correction température (°, 1 déc. séparée par .)";
...
const char INTL_S88[] PROGMEM = "Sonde SensAir S88";
...
const char INTL_FS_WIFI_DESCRIPTION[] PROGMEM =
    "Nom du capteur wifi en mode de configuration";
...
const char INTL_DISPLAY_LORA_INFO[] PROGMEM =
    "Afficher les informations LoRaWAN";
...
const char INTL_SEND_TO_OWN_API[] PROGMEM =
    "Envoyer les données vers l'API AirCarto";
const char INTL_SEND_TO_OWN_API2[] PROGMEM =
    "Envoyer les données vers l'API AtmoSud";
...
const char INTL_SENSOR_IS_REBOOTING[] PROGMEM =
    "Le détecteur est en train de redémarrer.";
...
#define INTL_CONFIGURATION_REALLY_DELETE                                       \
  "Voulez-vous vraiment effacer la configuration?"
...
const char INTL_TEMPERATURE_CORRECTED[] PROGMEM = "Température corrigée";
...
const char INTL_LORA_EXPLANATION[] =
    "Copier/Coller les valeurs depuis la console Helium";
